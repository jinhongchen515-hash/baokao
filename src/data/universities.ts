...
export const universitiesByProvince: Record<string, University[]> = {
  北京: [
    ...
    { id: "bj-16", name: "首都经济贸易大学", province: "北京", city: "北京", type: "财经", level: "普通本科", is985: false, is211: false, isDoubleFirst: false, features: ["财经强校", "经济学突出", "北京就业优势"], scoreRange: { min: 545, max: 570 }, rankRange: { min: 28000, max: 40000 }, hotMajors: ["经济学", "金融学", "会计学", "工商管理", "法学"], website: "https://www.cueb.edu.cn" },
    { id: "bj-17", name: "北京工业大学", province: "北京", city: "北京", type: "理工", level: "211", is985: false, is211: true, isDoubleFirst: true, features: ["工科强校", "土木领先", "市属重点"], scoreRange: { min: 585, max: 605 }, rankRange: { min: 14000, max: 22000 }, hotMajors: ["土木工程", "计算机", "环境工程", "材料科学", "电子工程"], website: "https://www.bjut.edu.cn" },
    { id: "bj-18", name: "北方工业大学", province: "北京", city: "北京", type: "理工", level: "普通本科", is985: false, is211: false, isDoubleFirst: false, features: ["工科特色", "计算机强", "应用型"], scoreRange: { min: 510, max: 535 }, rankRange: { min: 44000, max: 58000 }, hotMajors: ["计算机", "电子信息", "自动化", "建筑学", "机械工程"], website: "https://www.ncut.edu.cn" },
    { id: "bj-19", name: "北京建筑大学", province: "北京", city: "北京", type: "理工", level: "普通本科", is985: false, is211: false, isDoubleFirst: false, features: ["建筑特色", "土木强", "城市规划"], scoreRange: { min: 505, max: 530 }, rankRange: { min: 46000, max: 60000 }, hotMajors: ["建筑学", "土木工程", "城乡规划", "给排水", "环境工程"], website: "https://www.bucea.edu.cn" },
    { id: "bj-20", name: "首都师范大学", province: "北京", city: "北京", type: "师范", level: "双一流", is985: false, is211: false, isDoubleFirst: true, features: ["师范强校", "数学突出", "文理并重"], scoreRange: { min: 555, max: 580 }, rankRange: { min: 23000, max: 35000 }, hotMajors: ["教育学", "数学", "汉语言文学", "地理学", "生物学"], website: "https://www.cnu.edu.cn" },
  ],
  上海: [
    ...
    { id: "sh-09", name: "上海理工大学", province: "上海", city: "上海", type: "理工", level: "普通本科", is985: false, is211: false, isDoubleFirst: false, features: ["工科强校", "光学特色", "制造业对口"], scoreRange: { min: 530, max: 555 }, rankRange: { min: 35000, max: 50000 }, hotMajors: ["光学工程", "机械工程", "计算机", "电子信息", "能源动力"], website: "https://www.usst.edu.cn" },
    { id: "sh-10", name: "上海师范大学", province: "上海", city: "上海", type: "师范", level: "普通本科", is985: false, is211: false, isDoubleFirst: false, features: ["师范强校", "教育学前导", "文科突出"], scoreRange: { min: 520, max: 545 }, rankRange: { min: 38000, max: 52000 }, hotMajors: ["教育学", "汉语言文学", "数学", "化学", "心理学"], website: "https://www.shnu.edu.cn" },
    { id: "sh-11", name: "上海海事大学", province: "上海", city: "上海", type: "理工", level: "普通本科", is985: false, is211: false, isDoubleFirst: false, features: ["航运特色", "物流管理", "交通运输"], scoreRange: { min: 510, max: 535 }, rankRange: { min: 44000, max: 58000 }, hotMajors: ["航海技术", "物流管理", "交通运输", "法学", "计算机"], website: "https://www.shmtu.edu.cn" },
  ],
  广东: [
    ...
    { id: "gd-07", name: "广东工业大学", province: "广东", city: "广州", type: "理工", level: "普通本科", is985: false, is211: false, isDoubleFirst: false, features: ["工科强校", "自动化特色", "产教融合"], scoreRange: { min: 520, max: 545 }, rankRange: { min: 38000, max: 52000 }, hotMajors: ["自动化", "计算机", "机械工程", "材料科学", "土木工程"], website: "https://www.gdut.edu.cn" },
    { id: "gd-08", name: "广州大学", province: "广东", city: "广州", type: "综合", level: "普通本科", is985: false, is211: false, isDoubleFirst: false, features: ["综合大学", "土木强", "数学特色"], scoreRange: { min: 515, max: 540 }, rankRange: { min: 40000, max: 54000 }, hotMajors: ["土木工程", "数学", "计算机", "教育学", "环境工程"], website: "https://www.gzhu.edu.cn" },
    { id: "gd-09", name: "汕头大学", province: "广东", city: "汕头", type: "综合", level: "普通本科", is985: false, is211: false, isDoubleFirst: false, features: ["李嘉诚创办", "医学特色", "国际合作"], scoreRange: { min: 510, max: 535 }, rankRange: { min: 44000, max: 58000 }, hotMajors: ["临床医学", "计算机", "法学", "英语", "工商管理"], website: "https://www.stu.edu.cn" },
    { id: "gd-10", name: "广州中医药大学", province: "广东", city: "广州", type: "医学", level: "双一流", is985: false, is211: false, isDoubleFirst: true, features: ["中医名校", "双一流", "针灸推拿"], scoreRange: { min: 520, max: 545 }, rankRange: { min: 38000, max: 52000 }, hotMajors: ["中医学", "针灸推拿", "中药学", "护理学", "中西医结合"], website: "https://www.gzucm.edu.cn" },
  ],
  江苏: [
    ...
    { id: "js-07", name: "南京师范大学", province: "江苏", city: "南京", type: "师范", level: "211", is985: false, is211: true, isDoubleFirst: true, features: ["师范强校", "教育学领先", "文理并重"], scoreRange: { min: 575, max: 595 }, rankRange: { min: 18000, max: 26000 }, hotMajors: ["教育学", "汉语言文学", "数学", "地理学", "生物学"], website: "https://www.nnu.edu.cn" },
    { id: "js-08", name: "南京审计大学", province: "江苏", city: "南京", type: "财经", level: "普通本科", is985: false, is211: false, isDoubleFirst: false, features: ["审计特色", "财经强校", "就业好"], scoreRange: { min: 535, max: 560 }, rankRange: { min: 31000, max: 45000 }, hotMajors: ["审计学", "会计学", "金融学", "经济学", "法学"], website: "https://www.nau.edu.cn" },
    { id: "js-09", name: "扬州大学", province: "江苏", city: "扬州", type: "综合", level: "普通本科", is985: false, is211: false, isDoubleFirst: false, features: ["百年名校", "农学特色", "文理兼顾"], scoreRange: { min: 520, max: 545 }, rankRange: { min: 38000, max: 52000 }, hotMajors: ["农学", "兽医学", "化学", "计算机", "汉语言文学"], website: "https://www.yzu.edu.cn" },
    { id: "js-10", name: "南京工业大学", province: "江苏", city: "南京", type: "理工", level: "普通本科", is985: false, is211: false, isDoubleFirst: false, features: ["化工强校", "材料科学", "安全工程"], scoreRange: { min: 515, max: 540 }, rankRange: { min: 40000, max: 54000 }, hotMajors: ["化学工程", "材料科学", "安全工程", "计算机", "土木工程"], website: "https://www.njtech.edu.cn" },
  ],
  浙江: [
    ...
    { id: "zj-04", name: "杭州电子科技大学", province: "浙江", city: "杭州", type: "理工", level: "普通本科", is985: false, is211: false, isDoubleFirst: false, features: ["电子信息强校", "IT就业好", "国防特色"], scoreRange: { min: 560, max: 585 }, rankRange: { min: 24000, max: 35000 }, hotMajors: ["计算机", "电子信息", "通信工程", "自动化", "网络空间安全"], website: "https://www.hdu.edu.cn" },
    { id: "zj-05", name: "浙江理工大学", province: "浙江", city: "杭州", type: "理工", level: "普通本科", is985: false, is211: false, isDoubleFirst: false, features: ["纺织特色", "工科突出", "就业好"], scoreRange: { min: 530, max: 555 }, rankRange: { min: 33000, max: 48000 }, hotMajors: ["纺织工程", "计算机", "机械工程", "电子信息", "服装设计"], website: "https://www.zstu.edu.cn" },
    { id: "zj-06", name: "浙江工商大学", province: "浙江", city: "杭州", type: "财经", level: "普通本科", is985: false, is211: false, isDoubleFirst: false, features: ["财经特色", "统计学强", "就业好"], scoreRange: { min: 540, max: 565 }, rankRange: { min: 29000, max: 42000 }, hotMajors: ["会计学", "金融学", "统计学", "工商管理", "法学"], website: "https://www.zjsu.edu.cn" },
  ],
  湖北: [
    ...
    { id: "hb-06", name: "武汉科技大学", province: "湖北", city: "武汉", type: "理工", level: "普通本科", is985: false, is211: false, isDoubleFirst: false, features: ["钢铁特色", "材料科学强", "工科突出"], scoreRange: { min: 530, max: 555 }, rankRange: { min: 33000, max: 48000 }, hotMajors: ["材料科学", "冶金工程", "机械工程", "计算机", "土木工程"], website: "https://www.wust.edu.cn" },
    { id: "hb-07", name: "湖北大学", province: "湖北", city: "武汉", type: "综合", level: "普通本科", is985: false, is211: false, isDoubleFirst: false, features: ["省属重点", "文理并重", "材料特色"], scoreRange: { min: 520, max: 545 }, rankRange: { min: 38000, max: 52000 }, hotMajors: ["材料科学", "汉语言文学", "化学", "生物学", "教育学"], website: "https://www.hubu.edu.cn" },
    { id: "hb-08", name: "中南民族大学", province: "湖北", city: "武汉", type: "民族", level: "普通本科", is985: false, is211: false, isDoubleFirst: false, features: ["民族特色", "化学学科", "法学"], scoreRange: { min: 510, max: 535 }, rankRange: { min: 44000, max: 58000 }, hotMajors: ["民族学", "化学", "法学", "计算机", "经济学"], website: "https://www.scuec.edu.cn" },
  ],
  四川: [
    ...
    { id: "sc-05", name: "成都理工大学", province: "四川", city: "成都", type: "理工", level: "双一流", is985: false, is211: false, isDoubleFirst: true, features: ["地质特色", "双一流", "能源学科"], scoreRange: { min: 530, max: 555 }, rankRange: { min: 33000, max: 48000 }, hotMajors: ["地质学", "地球物理", "石油工程", "土木工程", "计算机"], website: "https://www.cdut.edu.cn" },
    { id: "sc-06", name: "四川师范大学", province: "四川", city: "成都", type: "师范", level: "普通本科", is985: false, is211: false, isDoubleFirst: false, features: ["师范强校", "教育学领先", "西部重点"], scoreRange: { min: 510, max: 535 }, rankRange: { min: 44000, max: 58000 }, hotMajors: ["教育学", "汉语言文学", "数学", "化学", "历史学"], website: "https://www.sicnu.edu.cn" },
    { id: "sc-07", name: "西南石油大学", province: "四川", city: "成都", type: "理工", level: "双一流", is985: false, is211: false, isDoubleFirst: true, features: ["石油特色", "能源强校", "双一流"], scoreRange: { min: 510, max: 535 }, rankRange: { min: 44000, max: 58000 }, hotMajors: ["石油工程", "地质工程", "机械工程", "计算机", "化学工程"], website: "https://www.swpu.edu.cn" },
  ],
  福建: [
  ...
  天津: [
    ...
    { id: "tj-05", name: "天津师范大学", province: "天津", city: "天津", type: "师范", level: "普通本科", is985: false, is211: false, isDoubleFirst: false, features: ["师范强校", "教育学领先", "文理并重"], scoreRange: { min: 520, max: 545 }, rankRange: { min: 38000, max: 52000 }, hotMajors: ["教育学", "汉语言文学", "数学", "化学", "历史学"], website: "https://www.tjnu.edu.cn" },
    { id: "tj-06", name: "天津工业大学", province: "天津", city: "天津", type: "理工", level: "双一流", is985: false, is211: false, isDoubleFirst: true, features: ["纺织特色", "材料科学强", "双一流"], scoreRange: { min: 530, max: 555 }, rankRange: { min: 33000, max: 48000 }, hotMajors: ["纺织工程", "材料科学", "计算机", "化学工程", "环境工程"], website: "https://www.tiangong.edu.cn" },
  ],
  湖南: [
    ...
    { id: "hn-05", name: "长沙理工大学", province: "湖南", city: "长沙", type: "理工", level: "普通本科", is985: false, is211: false, isDoubleFirst: false, features: ["交通电力", "工科突出", "就业好"], scoreRange: { min: 520, max: 545 }, rankRange: { min: 38000, max: 52000 }, hotMajors: ["交通运输", "电气工程", "土木工程", "计算机", "水利工程"], website: "https://www.csust.edu.cn" },
    { id: "hn-06", name: "湘潭大学", province: "湖南", city: "湘潭", type: "综合", level: "双一流", is985: false, is211: false, isDoubleFirst: true, features: ["百年名校", "法学强校", "数学突出"], scoreRange: { min: 520, max: 545 }, rankRange: { min: 38000, max: 52000 }, hotMajors: ["法学", "数学", "化学", "材料科学", "经济学"], website: "https://www.xtu.edu.cn" },
  ],
  山东: [
    ...
    { id: "sd-04", name: "山东科技大学", province: "山东", city: "青岛", type: "理工", level: "普通本科", is985: false, is211: false, isDoubleFirst: false, features: ["矿业特色", "工科突出", "青岛区位优势"], scoreRange: { min: 500, max: 525 }, rankRange: { min: 48000, max: 62000 }, hotMajors: ["矿业工程", "计算机", "土木工程", "电气工程", "机械工程"], website: "https://www.sdust.edu.cn" },
    { id: "sd-05", name: "青岛大学", province: "山东", city: "青岛", type: "综合", level: "普通本科", is985: false, is211: false, isDoubleFirst: false, features: ["综合大学", "医学强", "纺织特色"], scoreRange: { min: 510, max: 535 }, rankRange: { min: 44000, max: 58000 }, hotMajors: ["临床医学", "纺织工程", "计算机", "经济学", "医学影像"], website: "https://www.qdu.edu.cn" },
    { id: "sd-06", name: "山东师范大学", province: "山东", city: "济南", type: "师范", level: "普通本科", is985: false, is211: false, isDoubleFirst: false, features: ["师范强校", "教育学领先", "文理并重"], scoreRange: { min: 510, max: 535 }, rankRange: { min: 44000, max: 58000 }, hotMajors: ["教育学", "汉语言文学", "数学", "化学", "生物科学"], website: "https://www.sdnu.edu.cn" },
  ],
  辽宁: [
    ...
    { id: "ln-04", name: "东北财经大学", province: "辽宁", city: "大连", type: "财经", level: "普通本科", is985: false, is211: false, isDoubleFirst: false, features: ["财经名校", "会计学强", "经济学突出"], scoreRange: { min: 550, max: 575 }, rankRange: { min: 26000, max: 38000 }, hotMajors: ["会计学", "金融学", "经济学", "财政学", "工商管理"], website: "https://www.dufe.edu.cn" },
    { id: "ln-05", name: "沈阳工业大学", province: "辽宁", city: "沈阳", type: "理工", level: "普通本科", is985: false, is211: false, isDoubleFirst: false, features: ["工科强校", "电气特色", "制造业对口"], scoreRange: { min: 480, max: 510 }, rankRange: { min: 58000, max: 70000 }, hotMajors: ["电气工程", "机械工程", "计算机", "材料科学", "自动化"], website: "https://www.sut.edu.cn" },
    { id: "ln-06", name: "辽宁大学", province: "辽宁", city: "沈阳", type: "综合", level: "211", is985: false, is211: true, isDoubleFirst: true, features: ["省属211", "经济学强", "文理并重"], scoreRange: { min: 550, max: 570 }, rankRange: { min: 25000, max: 38000 }, hotMajors: ["经济学", "金融学", "法学", "新闻学", "化学"], website: "https://www.lnu.edu.cn" },
  ],
  吉林: [
    ...
    { id: "jl-02", name: "东北师范大学", province: "吉林", city: "长春", type: "师范", level: "211", is985: false, is211: true, isDoubleFirst: true, features: ["师范强校", "教育学领先", "文科突出"], scoreRange: { min: 565, max: 585 }, rankRange: { min: 20000, max: 30000 }, hotMajors: ["教育学", "心理学", "汉语言文学", "数学", "化学"], website: "https://www.nenu.edu.cn" },
  ],
  黑龙江: [
    ...
    { id: "hlj-03", name: "东北农业大学", province: "黑龙江", city: "哈尔滨", type: "农林", level: "211", is985: false, is211: true, isDoubleFirst: true, features: ["农林特色", "食品科学", "生命科学"], scoreRange: { min: 510, max: 535 }, rankRange: { min: 44000, max: 58000 }, hotMajors: ["农学", "食品科学", "动物医学", "生物学", "园艺"], website: "https://www.neau.edu.cn" },
    { id: "hlj-04", name: "哈尔滨理工大学", province: "黑龙江", city: "哈尔滨", type: "理工", level: "普通本科", is985: false, is211: false, isDoubleFirst: false, features: ["工科特色", "电气强", "制造业对口"], scoreRange: { min: 470, max: 500 }, rankRange: { min: 65000, max: 80000 }, hotMajors: ["电气工程", "计算机", "机械工程", "材料科学", "自动化"], website: "https://www.hrbust.edu.cn" },
  ],
  重庆: [
    ...
    { id: "cq-03", name: "重庆邮电大学", province: "重庆", city: "重庆", type: "理工", level: "普通本科", is985: false, is211: false, isDoubleFirst: false, features: ["信息特色", "通信强", "IT就业好"], scoreRange: { min: 520, max: 545 }, rankRange: { min: 38000, max: 52000 }, hotMajors: ["通信工程", "计算机", "电子信息", "自动化", "软件工程"], website: "https://www.cqupt.edu.cn" },
    { id: "cq-04", name: "重庆医科大学", province: "重庆", city: "重庆", type: "医学", level: "普通本科", is985: false, is211: false, isDoubleFirst: false, features: ["医学强校", "临床医学", "儿科"], scoreRange: { min: 530, max: 560 }, rankRange: { min: 33000, max: 48000 }, hotMajors: ["临床医学", "口腔医学", "儿科学", "护理学", "医学影像"], website: "https://www.cqmu.edu.cn" },
  ],
  陕西: [
    ...
    { id: "sn-06", name: "西安建筑科技大学", province: "陕西", city: "西安", type: "理工", level: "普通本科", is985: false, is211: false, isDoubleFirst: false, features: ["建筑老八校", "土木强校", "工科突出"], scoreRange: { min: 520, max: 545 }, rankRange: { min: 38000, max: 52000 }, hotMajors: ["建筑学", "土木工程", "城乡规划", "环境工程", "材料科学"], website: "https://www.xauat.edu.cn" },
    { id: "sn-07", name: "陕西师范大学", province: "陕西", city: "西安", type: "师范", level: "211", is985: false, is211: true, isDoubleFirst: true, features: ["师范强校", "教育学领先", "西部名校"], scoreRange: { min: 560, max: 580 }, rankRange: { min: 20000, max: 30000 }, hotMajors: ["教育学", "汉语言文学", "数学", "化学", "历史学"], website: "https://www.snnu.edu.cn" },
    { id: "sn-08", name: "西安理工大学", province: "陕西", city: "西安", type: "理工", level: "普通本科", is985: false, is211: false, isDoubleFirst: false, features: ["工科强校", "水利特色", "印刷包装"], scoreRange: { min: 500, max: 525 }, rankRange: { min: 48000, max: 62000 }, hotMajors: ["水利工程", "机械工程", "计算机", "电气工程", "材料科学"], website: "https://www.xaut.edu.cn" },
  ],
  安徽: [
    ...
    { id: "ah-03", name: "安徽大学", province: "安徽", city: "合肥", type: "综合", level: "211", is985: false, is211: true, isDoubleFirst: true, features: ["省属211", "计算机特色", "文理并重"], scoreRange: { min: 540, max: 565 }, rankRange: { min: 29000, max: 42000 }, hotMajors: ["计算机", "英语", "法学", "经济学", "化学"], website: "https://www.ahu.edu.cn" },
    { id: "ah-04", name: "安徽师范大学", province: "安徽", city: "芜湖", type: "师范", level: "普通本科", is985: false, is211: false, isDoubleFirst: false, features: ["师范强校", "教育学领先", "文科突出"], scoreRange: { min: 500, max: 525 }, rankRange: { min: 48000, max: 62000 }, hotMajors: ["教育学", "汉语言文学", "数学", "化学", "历史学"], website: "https://www.ahnu.edu.cn" },
  ],
  甘肃: [
    ...
    { id: "gs-02", name: "兰州理工大学", province: "甘肃", city: "兰州", type: "理工", level: "普通本科", is985: false, is211: false, isDoubleFirst: false, features: ["工科特色", "材料科学", "制造业对口"], scoreRange: { min: 460, max: 490 }, rankRange: { min: 70000, max: 85000 }, hotMajors: ["材料科学", "机械工程", "计算机", "土木工程", "电气工程"], website: "https://www.lut.edu.cn" },
  ],
  河南: [
    { id: "hn-ha-01", name: "郑州大学", province: "河南", city: "郑州", type: "综合", level: "211", is985: false, is211: true, isDoubleFirst: true, features: ["省属211", "规模大", "医学强"], scoreRange: { min: 570, max: 590 }, rankRange: { min: 18000, max: 26000 }, hotMajors: ["临床医学", "化学", "材料科学", "计算机", "法学"], website: "https://www.zzu.edu.cn" },
    { id: "hn-ha-02", name: "河南大学", province: "河南", city: "开封", type: "综合", level: "双一流", is985: false, is211: false, isDoubleFirst: true, features: ["百年名校", "生物学特色", "文史见长"], scoreRange: { min: 530, max: 555 }, rankRange: { min: 33000, max: 48000 }, hotMajors: ["生物学", "教育学", "汉语言文学", "化学", "地理学"], website: "https://www.henu.edu.cn" },
    { id: "hn-ha-03", name: "河南科技大学", province: "河南", city: "洛阳", type: "理工", level: "普通本科", is985: false, is211: false, isDoubleFirst: false, features: ["工科特色", "轴承研究", "制造业对口"], scoreRange: { min: 490, max: 515 }, rankRange: { min: 53000, max: 65000 }, hotMajors: ["机械工程", "材料科学", "计算机", "车辆工程", "电子信息"], website: "https://www.haust.edu.cn" },
  ],
  江西: [
    { id: "jx-01", name: "南昌大学", province: "江西", city: "南昌", type: "综合", level: "211", is985: false, is211: true, isDoubleFirst: true, features: ["省属211", "医学特色", "工科突出"], scoreRange: { min: 555, max: 575 }, rankRange: { min: 25000, max: 38000 }, hotMajors: ["临床医学", "材料科学", "化学", "计算机", "食品科学"], website: "https://www.ncu.edu.cn" },
    { id: "jx-02", name: "江西财经大学", province: "江西", city: "南昌", type: "财经", level: "普通本科", is985: false, is211: false, isDoubleFirst: false, features: ["财经强校", "会计学强", "就业好"], scoreRange: { min: 530, max: 555 }, rankRange: { min: 33000, max: 48000 }, hotMajors: ["会计学", "金融学", "经济学", "财政学", "统计学"], website: "https://www.jxufe.edu.cn" },
    { id: "jx-03", name: "华东交通大学", province: "江西", city: "南昌", type: "理工", level: "普通本科", is985: false, is211: false, isDoubleFirst: false, features: ["交通特色", "工科突出", "铁路背景"], scoreRange: { min: 490, max: 515 }, rankRange: { min: 53000, max: 65000 }, hotMajors: ["交通运输", "土木工程", "电气工程", "计算机", "机械工程"], website: "https://www.ecjtu.edu.cn" },
  ],
  广西: [
    { id: "gx-01", name: "广西大学", province: "广西", city: "南宁", type: "综合", level: "211", is985: false, is211: true, isDoubleFirst: true, features: ["省属211", "工学突出", "东盟合作"], scoreRange: { min: 520, max: 545 }, rankRange: { min: 38000, max: 52000 }, hotMajors: ["土木工程", "化学工程", "计算机", "电气工程", "农学"], website: "https://www.gxu.edu.cn" },
    { id: "gx-02", name: "广西师范大学", province: "广西", city: "桂林", type: "师范", level: "普通本科", is985: false, is211: false, isDoubleFirst: false, features: ["师范强校", "文理并重", "旅游管理"], scoreRange: { min: 490, max: 515 }, rankRange: { min: 53000, max: 65000 }, hotMajors: ["教育学", "汉语言文学", "化学", "数学", "旅游管理"], website: "https://www.gxnu.edu.cn" },
  ],
  云南: [
    { id: "yn-01", name: "云南大学", province: "云南", city: "昆明", type: "综合", level: "211", is985: false, is211: true, isDoubleFirst: true, features: ["省属211", "民族学强", "生态学突出"], scoreRange: { min: 535, max: 560 }, rankRange: { min: 31000, max: 45000 }, hotMajors: ["民族学", "生态学", "化学", "生物学", "政治学"], website: "https://www.ynu.edu.cn" },
    { id: "yn-02", name: "昆明理工大学", province: "云南", city: "昆明", type: "理工", level: "普通本科", is985: false, is211: false, isDoubleFirst: false, features: ["工科强校", "冶金特色", "西南重点"], scoreRange: { min: 490, max: 520 }, rankRange: { min: 53000, max: 68000 }, hotMajors: ["冶金工程", "机械工程", "计算机", "土木工程", "材料科学"], website: "https://www.kmust.edu.cn" },
  ],
};
